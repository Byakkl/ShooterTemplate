...
{
    //Reference to the scriptable object that contains the GameController instance
    [SerializeField]
    ...
    public virtual void Spawn(){
        ...
        //Determine if the spawned object is an item
        IItem itemInstance = instance.GetComponent<IItem>();
        if(itemInstance != null){
            //Activate the item
            itemInstance.isItemActive = true;
            //Inform the GameController of the item that needs to be trackeds
