...
public class Gun : IItem
{
    ...
    /// <summary>
    /// Gets the current ammo in the gun
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Gets the maximum ammo the gun can hold
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Sets the transform reference that determines where projectiles will be fired from
    /// </summary>
    /// <param name="a_origin">The transform to act as firing origin</param>
    public void SetFireOrigin(Transform a_origin){
        fireOrigin = a_origin;
    }

    /// <summary>
    /// Activates and sets rigidbody physics on a given projectile
    /// </summary>
